...
define(function (require) {
    ...
    return {
    	...
    	init: function init(content, eventManager) {
			...
			// SI - for whatever reason, PAF double-encodes our json they shove into targetActivity so we need to 
			// parse that out
			var newTarget = JSON.parse(content.targetActivity);
			
			newTarget.master.brix.forEach(function(bric){
