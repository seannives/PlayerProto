...
*  
 * @param {Array}		config.key   	- string used to relate the content
 ...
 * @param {string}		textBits.content.type - switch to autogenerate numbers
...
Callouts.prototype.draw = function (node) { //begin callout drawing method
	...
	//supply col0, col1, etc., you get multiple columns.
		...
		.html(function(d,i,j) {
				var label = "";
				if(that.textBits.type == "numbered"){
